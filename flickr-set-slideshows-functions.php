...
function make_gallery_html( $gal_id ) {
    ...
    //create html
    $html = '<object width="'.$w.'" height="'.$h.'"><param name="flashvars"value="offsite=true&lang=en-us&page_show_url=%2Fphotos%2F'.$user_id.'%2Fsets%2F'.$gallery->set_id.'%2Fshow%2F&page_show_back_url=%2Fphotos%2F'.$user_id.'%2Fsets%2F'.$gallery->set_id.'%2F&set_id='.$gallery->set_id.'&jump_to="></param><param name="movie" value="https://www.flickr.com/apps/slideshow/show.swf?v=109615"></param><param name="allowFullScreen" value="true"></param><embed type="application/x-shockwave-flash" src="https://www.flickr.com/apps/slideshow/show.swf?v=109615" allowFullScreen="true" flashvars="offsite=true&lang=en-us&page_show_url=%2Fphotos%2F'.$user_id.'%2Fsets%2F'.$gallery->set_id.'%2Fshow%2F&page_show_back_url=%2Fphotos%2F'.$user_id.'%2Fsets%2F'.$gallery->set_id.'%2F&set_id='.$gallery->set_id.'&jump_to=" width="'.$w.'" height="'.$h.'"></embed></object>';
    return $html;
}
